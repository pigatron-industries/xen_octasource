#ifndef DoubleSpringPendulum_h
#define DoubleSpringPendulum_h
...
class DoubleSpringPendulum : public ContinuousSystemN<2> {
    public:
    ...
    private:
        ...
        //Body body2 = Body(Vector<2>(0, -3), Body::Type::FREE, 0.5, Vector<2>(0.01, 0.5));
